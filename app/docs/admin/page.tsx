  ...
  return (
    <PageShell footer={false}>
      <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
        ...
        <Link
          href="/docs"
          className="inline-flex h-9 items-center gap-1.5 rounded-lg border border-[var(--border-strong)] bg-white/[0.03] px-3.5 text-[13px] font-medium text-[var(--fg)] no-underline transition-colors hover:bg-white/[0.06]"
        >
          View /docs →
        </Link>
      </div>
