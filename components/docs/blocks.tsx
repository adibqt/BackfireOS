      ...
      return (
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {block.items.map((i) => (
            <div
              key={i.label}
              className="rounded-xl border border-[var(--border)] bg-[image:var(--veil)] p-4"
            >
      ...
      return (
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {block.items.map((i) => (
            <div
              key={i.title}
              className="rounded-xl border border-[var(--border)] bg-[var(--fill-faint)] p-4 transition-colors hover:border-[var(--border-strong)]"
            >
      ...
      return (
        <div className="overflow-x-auto rounded-xl border border-[var(--border)]">
          <table className="w-full border-collapse text-left text-[13px]">
            <thead>
              <tr className="border-b border-[var(--border)] bg-[var(--fill-faint)]">
                {block.headers.map((h) => (
